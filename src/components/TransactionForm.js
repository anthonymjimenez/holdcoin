  ...
  return(
      <div style={formDivStyle}>
          ...
          <form className="ui form" onSubmit={handleSubmit}>
              <div className="field">
                  <label>Size</label>
                  <input value={state.size} onChange={handleChange} type="number" placeholder="size"/>
              </div>
              <h2>Total price: ${state.size * state.crypto.price}</h2>
              <div>
                Buy
                <label className="toggle-switch"> 
                  <input type="checkbox" checked={state.side === "buy"} onChange={handleChange} placeholder="side" disabled={true}/>
                  <span className="switch" />
                </label>
              </div>
              <div className="field">
                  <label>Hold Price</label>
                  <input value={state.hold_price} onChange={handleChange} type="number" placeholder="hold_price"/>
              </div>
              <div className="field">
                  <label>Stop Limit</label>
                  <input value={state.stop_limit} onChange={handleChange} type="number" placeholder="stop_limit"/>
              </div>
